...
public class Utils {
    ...
    private static List<ClientHandshake> clientesSocket;
    ...
    public Utils() {
        ...
        if (this.clientesSocket == null) {
    		this.clientesSocket = new ArrayList<ClientHandshake>();
    	}
    }
    ...
    public static List<ClientHandshake> getClientesSocket() {
        return clientesSocket;
    }

    public static void setClientesSocket(List<ClientHandshake> clientesSocket) {
        Utils.clientesSocket = clientesSocket;
    }
